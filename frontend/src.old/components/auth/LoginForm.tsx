    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`
                ...
                focus:outline-none focus:ring-2 focus:ring-velocity-blue focus:border-transparent
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            type="button"
            className="flex justify-center items-center gap-2 px-4 py-2.5 border border-slate-300 rounded-xl hover:bg-slate-50 transition-colors"
          >
